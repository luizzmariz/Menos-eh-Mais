...
public class TestePerlinTerrain : MonoBehaviour
{
    [Header("Terrain")]
    public float depth;
    ...
    public void StartScript(float offsetX, float offsetZ, float terrainSize, float number, int depth, Vector2 tilePos)
    {
